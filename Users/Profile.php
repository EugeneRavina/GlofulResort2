...
<body>
 ...
 <?php
			...
			$sql1="SELECT * FROM reservedcomplete_tbl where UserID='$userid' && Status!='Canceled'";
			...
			while($rows=mysql_fetch_assoc($results1)){
						...
						echo "<td> ". $DateFrom ." to<br>" .$DateTo. "</td>";
