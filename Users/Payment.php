...
///////////////////// FOR TOTAL AND DOWNPAYMENT
	...
	//////// CATER FOR Price
			...
			echo "<form method='POST' action='PaymentSuccess.php' enctype='multipart/form-data'>";
			echo "Upload your file : <input type='file' name='image' required>";
			
			//echo "Amount : <input type='text' name='amount' required>";	
