...
<body>
	...
	<form method="POST" action="Book-Resort1.php">
	<h2>&nbsp; Select Date <br></h2>
   ...
   <br>
	...
	<tr>
		...
		echo "<td><center><a href=Book-Gloful-Step2Package.php?id=$id><i class='fa fa-info-circle'></i>&nbsp;Details</a></center></td>";
		echo "<td><a href=Book-Resort-Package1.php?id=$id class='btn btn-success'><i class='fa fa-check'></i>&nbsp; Select</i></a></td>";
		echo "</tr>";
		}
		?>
