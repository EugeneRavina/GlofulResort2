...
<div class="row">
	...
	echo $_SESSION['DateTo'];
		...
		echo "<br>Venue : ".$_SESSION['FType'];
		echo "<br>Venue Price: ".$_SESSION['FPrice'];
		echo "<br>Hour for venue: &nbsp;".$Times."<br>";
		...
		if($Extend!=0)
			...
			echo "Extention Price: " . $Extend*1000 . "<br>";
		...
		$insert="INSERT INTO reservedcatering_tbl (DateFrom, DateTo, EventName, CName, Theme, Motif, Guest, Package,Menu, Venue, Price, TimeVenue, TimeExtend, RCode) values('$DateFrom','$DateTo','$Type','$Celebname','$Theme','$Motif','$Guest','','','$FType','$FPrice','$Times','$Extend','$RCode')";
