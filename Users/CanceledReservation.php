            ...
            <div class="main">
               <table  class="table table-striped table-hover">
                    <thead class="thead">
						...
						$sql=" SELECT CONCAT(A.FName ,' ', A.LName) AS FullName , Dates , EventName ,Total, RCode, Status FROM user_tbl AS A INNER JOIN reservedcomplete_tbl AS B ON A.UserID=B.UserID WHERE Status='Canceled'";
