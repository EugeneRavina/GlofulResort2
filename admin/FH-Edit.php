...
$sql1="Select * from functionhall_tbl where ID='$_GET[id]'";
...
$images=$row['Image'];
$path="../Images/Function Hall/".$images;
...
<body>
<div class="main">
	<form method='POST' action='FH-Update.php' enctype="multipart/form-data">
		<table class='table full-width'>
			<div class="blue form-title center full-width"><h2>EDIT FUNCTION HALL</h2></div>
			<input type ="hidden" name="id" value="<?php echo $id; ?>">
											
			<tr>
				<td class="lbl">Function Hall Type</td>
				<td><input type='text' name='Type' class="textbox width90" value="<?php   echo $name;?>"  required></td>
			</tr>			
			<tr>
				<td class="lbl">Function Hall Description</td>
				<td><textarea name="Description" class="textbox width90"><?php  echo $desc;  ?></textarea></td>
			</tr>		
			<tr>
