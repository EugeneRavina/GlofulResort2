...
<title>Gloful Admin</title>
  ...
  $("#btn-add").click(function(){
    $(".content-loader").fadeOut('slow', function()
    {
      ...
      $(".content-loader").load('ContactAdd.php');
      $("#btn-add").hide();
      $("#btn-view").show();
    });
  });
   ...
   <div class="container">
     <div class="topbar">
      ...
      <?php include('Sidebar.php'); ?>
            ...
            <div class="main">
        <button class="btn btn-info" type="button" id="btn-add"> <i class="fa fa-pencil"></i> &nbsp; Add New Contact</button>
       <button class="btn btn-info" type="button" id="btn-view"> <i class="fa fa-eye"></i> &nbsp; View Contact/s</button>
            <br>
...
<?php
	 ...
	 $result=mysql_query($sql);
		...
		echo "<td><a href='#'id=$id class='ContactEdit-link' title='Edit'><i class='fa fa-pencil'></i></a></td>";
		echo "<td><a href='ContactDelete.php?id=$id' onclick='return confirm('sure to delete ?')'><i class='fa fa-trash-o'></i></td>";
		echo "</tr>";
		echo "</tbody>";
