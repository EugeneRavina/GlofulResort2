 ...
 <div class="container">
   <div class="topbar">
	  ...
	  <br>
		...
		<center>
            <div class="main">
			<h2>Function Hall Availability</h2>
	...
	if(isset($_POST['search'])){
	 ...
	 $result1=mysql_query($sql);
		...
		echo "<td>". $Type."</td>";
			...
			$select="SELECT SUM(TimeVenue) AS TimeVenue , SUM(TimeExtend) AS TimeExtend FROM reservedcatering_tbl WHERE Venue='$Type' && DateFrom='$DateFrom'";
			...
			$TimeTotal=$TimeExtend+$TimeVenue;
			$Remaining=24-$TimeTotal;
			...
			echo "<td>". $TimeTotal." hours </td>";
			echo "<td>". $Remaining." hours </td>";
			}
