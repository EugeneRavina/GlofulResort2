        ...
        <?php include('Sidebar.php'); ?>
			...
			<center>
               <table  class="table table-striped table-hover">
				...
				<br>
				<tr>
					<th colspan='5'><center><h2>Reschedule Reservation Report</h2></th>
				</tr>
					...
					$sql="SELECT CONCAT(user_tbl.FName, user_tbl.LName) AS FullName, reservedcomplete_tbl.DateFrom , reservedcomplete_tbl.DateTo , reservedcomplete_tbl.EventName, reservedcomplete_tbl.Total, reservedcomplete_tbl.Status FROM user_tbl INNER JOIN reservedcomplete_tbl ON user_tbl.UserID = reservedcomplete_tbl.UserID WHERE date_transaction BETWEEN '$FromDate' AND '$ToDate' AND STATUS='Reschedule' ORDER BY date_transaction DESC";
					...
					$sql1="SELECT SUM(Total)as Total FROM user_tbl INNER JOIN reservedcomplete_tbl ON user_tbl.UserID = reservedcomplete_tbl.UserID WHERE date_transaction BETWEEN '$FromDate' AND '$ToDate' AND STATUS='Reschedule' ORDER BY date_transaction DESC";
