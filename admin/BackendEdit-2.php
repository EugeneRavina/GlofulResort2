...
if(isSet($_POST['submitbtn'])){
	...
	$Sdesc = $_POST['Sdesc'];
		...
		if($Pic == "")
		{
      $sql3="Update logo_tbl  SET Name = '$STitle', Description = '$Sdesc' where LogID = '$Sid'";
		...
		else
		{
	        ...
	        if(in_array($ext, $valid_extensions))
	    	{
	    		if(move_uploaded_file($_FILES['Picture']['tmp_name'], $path))
	    		{
	    			...
	    			$sql3="Update logo_tbl SET Image = '$img2', Name = '$STitle', Description = '$Sdesc' where LogID = '$Sid'";
            $result3=mysql_query($sql3);
